import { Text, Flex, Box, Heading, Image, Button,Hide } from "@chakra-ui/react";
  ...
  return (
    <>
      <Flex minH={"100vh"} w={"100vw"} bg={"#f3dadf"} overflow={"hidden"}>
        ...
        >
          <ReactLink to={"/"}>
            <Text pos={"absolute"} top={5} left={5} color={"black"} fontSize={{base:'md', xl:'xl'}}>
              {"< Back"}
            </Text>
          </ReactLink>
          {/* {isError && (
          ...
          <Flex
            ...
            alignItems={"center"}
          >
            <Text fontSize={{base:'md', xl:'xl'}}>Don't have an account?</Text>
            <ReactLink to={"/register"} ml={1}>
              <Text color={"lightblue"} fontSize={{base:'md', xl:'xl'}}>Register</Text>
            </ReactLink>
          </Flex>
        </Flex>
      </Flex>
