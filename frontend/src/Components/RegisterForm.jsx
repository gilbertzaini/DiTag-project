// LoginForm.js
import { Text, Flex, Box, Heading, Image, Button, Hide, Input } from "@chakra-ui/react";
    ...
    <>
      <Flex minH={"100vh"} w={"100vw"} bg={"#f3dadf"} overflow={"hidden"}>
        ...
        >
          ...
          {/* <Text fontSize={{ base: "24px", md: "40px", lg: "56px" }}></Text> */}
          <Heading
            textAlign={"center"}
          ...
          <Flex
            ...
            alignItems={"center"}
          >
            <Text fontSize={{base:'md', xl:'xl'}}>Already have an account?</Text>
            <ReactLink to="/login" ml={1}>
              <Text color={"lightblue"} fontSize={{base:'md', xl:'xl'}}>Log In</Text>
            </ReactLink>
          </Flex>
        </Flex>
      </Flex>
